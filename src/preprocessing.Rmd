...
```{r}
df1[hh_duelxp & hh_no_oil,]$elec_ratio[1] / df1[hh_duelxp & hh_no_oil,]$gas_ratio[1]
...
``` {r}
write_sav(df1, "data/i_hhresp_preprocessed.sav")
write_sav(dfgood, "data/dfgood.sav")
saveRDS(svy_all, "data/svy_all.rds")
saveRDS(svy_good, "data/svy_good.rds")
```
