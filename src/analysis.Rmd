...
Using Paul Tol's colorblind-aware color scheme.
...
my_colors[my_breaks > per_capita_co2_quartiles[1] & my_breaks <= per_capita_co2_quartiles[2]] <- "#228833"
my_colors[my_breaks > per_capita_co2_quartiles[2] & my_breaks <= per_capita_co2_quartiles[3]] <- "#CCBB44"
